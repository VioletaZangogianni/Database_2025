...
type_analysis (fest_year, fest_name, Total, VIP, Backstage, Regular, Student) AS (SELECT fest_year, fest_name, vip_total+back_total+std_total+student_total, vip_total, back_total, std_total, student_total FROM  VIP_total NATURAL JOIN back_total NATURAL JOIN std_total NATURAL JOIN student_total),
