...
SELECT G1.genre_desc AS first_genre, G2.genre_desc AS second_genre, AVG(G1.rev) AS score FROM g_art_perf G1, g_art_perf G2 WHERE G1.artist_id = G2.artist_id
