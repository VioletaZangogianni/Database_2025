...
SELECT CONCAT(visitor_name, ' ', visitor_surname) AS Reviewer, artist_name AS Artist, review_interpretation + review_overall_impression AS Score FROM visitor NATURAL JOIN review NATURAL JOIN art_perf
